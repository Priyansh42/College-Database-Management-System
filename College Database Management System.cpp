...
cout<<"\t\t\tFACULTY INFORMATION AND BIODATA SECTION\n\n\n";
cout<<"\t\t\t\t1. Create new entry\n";
...
case '3':
{
 cout<<"Created By : MANAN SHAH    ; ID NO. : 19CE136";
 cout<<"\n             PRIYANSH SHAH ; ID NO. : 19CE137";
 cout<<"\n             KRISH SHEVANI ; ID NO. : 19CE142";
 cout<<"\n             GAURAV SUTHAR ; ID NO. : 19CE146";
break;//outer case 3
}//outer case 3
}   
break;//outer loop
